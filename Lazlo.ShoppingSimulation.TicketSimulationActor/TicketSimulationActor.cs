...
namespace Lazlo.ShoppingSimulation.TicketSimulationActor
{
    ...
    internal class TicketSimulationActor : Actor, ITicketSimulationActor
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<int> ITicketSimulationActor.GetCountAsync(CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        Task ITicketSimulationActor.SetCountAsync(int count, CancellationToken cancellationToken)
        {
